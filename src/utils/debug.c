...
#define PRINTF_BREAK(...) \
  ...
  switch (token->type) {
    ...
    // literals
    case LEXER_TOKEN_STRING: PRINTF_BREAK("TOKEN_STRING");
    case LEXER_TOKEN_NUMBER: PRINTF_BREAK("TOKEN_NUMBER");
    case LEXER_TOKEN_IDENTIFIER: PRINTF_BREAK("TOKEN_IDENTIFIER");

    // single-character tokens
    case LEXER_TOKEN_PLUS: PRINTF_BREAK("TOKEN_PLUS");
    case LEXER_TOKEN_MINUS: PRINTF_BREAK("TOKEN_MINUS");
    case LEXER_TOKEN_STAR: PRINTF_BREAK("TOKEN_STAR");
    case LEXER_TOKEN_SLASH: PRINTF_BREAK("TOKEN_SLASH");
    case LEXER_TOKEN_PERCENT: PRINTF_BREAK("TOKEN_PERCENT");
    case LEXER_TOKEN_BANG: PRINTF_BREAK("TOKEN_BANG");
    case LEXER_TOKEN_LESS: PRINTF_BREAK("TOKEN_LESS");
    case LEXER_TOKEN_EQUAL: PRINTF_BREAK("TOKEN_EQUAL");
    case LEXER_TOKEN_GREATER: PRINTF_BREAK("TOKEN_GREATER");
    case LEXER_TOKEN_DOT: PRINTF_BREAK("TOKEN_DOT");
    case LEXER_TOKEN_COMMA: PRINTF_BREAK("TOKEN_COMMA");
    case LEXER_TOKEN_COLON: PRINTF_BREAK("TOKEN_COLON");
    case LEXER_TOKEN_SEMICOLON: PRINTF_BREAK("TOKEN_SEMICOLON");
    case LEXER_TOKEN_QUESTION: PRINTF_BREAK("TOKEN_QUESTION");
    case LEXER_TOKEN_OPEN_PAREN: PRINTF_BREAK("TOKEN_OPEN_PAREN");
    case LEXER_TOKEN_CLOSE_PAREN: PRINTF_BREAK("TOKEN_CLOSE_PAREN");
    case LEXER_TOKEN_OPEN_CURLY_BRACE: PRINTF_BREAK("TOKEN_OPEN_CURLY_BRACE");
    ...
    case LEXER_TOKEN_GREATER_EQUAL: PRINTF_BREAK("TOKEN_GREATER_EQUAL");

    // reserved identifiers (keywords)
    case LEXER_TOKEN_TRUE: PRINTF_BREAK("TOKEN_TRUE");
    case LEXER_TOKEN_FALSE: PRINTF_BREAK("TOKEN_FALSE");
    case LEXER_TOKEN_VAR: PRINTF_BREAK("TOKEN_VAR");
    case LEXER_TOKEN_NIL: PRINTF_BREAK("TOKEN_NIL");
    case LEXER_TOKEN_AND: PRINTF_BREAK("TOKEN_AND");
    case LEXER_TOKEN_OR: PRINTF_BREAK("TOKEN_OR");
    case LEXER_TOKEN_FUN: PRINTF_BREAK("TOKEN_FUN");
    case LEXER_TOKEN_RETURN: PRINTF_BREAK("TOKEN_RETURN");
    case LEXER_TOKEN_IF: PRINTF_BREAK("TOKEN_IF");
    case LEXER_TOKEN_ELSE: PRINTF_BREAK("TOKEN_ELSE");
    case LEXER_TOKEN_WHILE: PRINTF_BREAK("TOKEN_WHILE");
    case LEXER_TOKEN_FOR: PRINTF_BREAK("TOKEN_FOR");
    case LEXER_TOKEN_CLASS: PRINTF_BREAK("TOKEN_CLASS");
    case LEXER_TOKEN_SUPER: PRINTF_BREAK("TOKEN_SUPER");
