...
#define PRINTF_BREAK(...) \
  ...
  switch (token->type) {
    // indicators
    case LEXER_TOKEN_ERROR: PRINTF_BREAK("LEXER_TOKEN_ERROR");
    case LEXER_TOKEN_EOF: PRINTF_BREAK("LEXER_TOKEN_EOF");

    // literals
    case LEXER_TOKEN_STRING: PRINTF_BREAK("LEXER_TOKEN_STRING");
    case LEXER_TOKEN_NUMBER: PRINTF_BREAK("LEXER_TOKEN_NUMBER");
    case LEXER_TOKEN_IDENTIFIER: PRINTF_BREAK("LEXER_TOKEN_IDENTIFIER");

    // single-character tokens
    case LEXER_TOKEN_PLUS: PRINTF_BREAK("LEXER_TOKEN_PLUS");
    case LEXER_TOKEN_MINUS: PRINTF_BREAK("LEXER_TOKEN_MINUS");
    case LEXER_TOKEN_STAR: PRINTF_BREAK("LEXER_TOKEN_STAR");
    case LEXER_TOKEN_SLASH: PRINTF_BREAK("LEXER_TOKEN_SLASH");
    case LEXER_TOKEN_PERCENT: PRINTF_BREAK("LEXER_TOKEN_PERCENT");
    case LEXER_TOKEN_BANG: PRINTF_BREAK("LEXER_TOKEN_BANG");
    case LEXER_TOKEN_LESS: PRINTF_BREAK("LEXER_TOKEN_LESS");
    case LEXER_TOKEN_EQUAL: PRINTF_BREAK("LEXER_TOKEN_EQUAL");
    case LEXER_TOKEN_GREATER: PRINTF_BREAK("LEXER_TOKEN_GREATER");
    case LEXER_TOKEN_DOT: PRINTF_BREAK("LEXER_TOKEN_DOT");
    case LEXER_TOKEN_COMMA: PRINTF_BREAK("LEXER_TOKEN_COMMA");
    case LEXER_TOKEN_COLON: PRINTF_BREAK("LEXER_TOKEN_COLON");
    case LEXER_TOKEN_SEMICOLON: PRINTF_BREAK("LEXER_TOKEN_SEMICOLON");
    case LEXER_TOKEN_QUESTION: PRINTF_BREAK("LEXER_TOKEN_QUESTION");
    case LEXER_TOKEN_OPEN_PAREN: PRINTF_BREAK("LEXER_TOKEN_OPEN_PAREN");
    case LEXER_TOKEN_CLOSE_PAREN: PRINTF_BREAK("LEXER_TOKEN_CLOSE_PAREN");
    case LEXER_TOKEN_OPEN_CURLY_BRACE: PRINTF_BREAK("LEXER_TOKEN_OPEN_CURLY_BRACE");
    case LEXER_TOKEN_CLOSE_CURLY_BRACE: PRINTF_BREAK("LEXER_TOKEN_CLOSE_CURLY_BRACE");

    // multi-character tokens
    case LEXER_TOKEN_BANG_EQUAL: PRINTF_BREAK("LEXER_TOKEN_BANG_EQUAL");
    case LEXER_TOKEN_LESS_EQUAL: PRINTF_BREAK("LEXER_TOKEN_LESS_EQUAL");
    case LEXER_TOKEN_EQUAL_EQUAL: PRINTF_BREAK("LEXER_TOKEN_EQUAL_EQUAL");
    case LEXER_TOKEN_GREATER_EQUAL: PRINTF_BREAK("LEXER_TOKEN_GREATER_EQUAL");

    // reserved identifiers (keywords)
    case LEXER_TOKEN_TRUE: PRINTF_BREAK("LEXER_TOKEN_TRUE");
    case LEXER_TOKEN_FALSE: PRINTF_BREAK("LEXER_TOKEN_FALSE");
    case LEXER_TOKEN_VAR: PRINTF_BREAK("LEXER_TOKEN_VAR");
    case LEXER_TOKEN_NIL: PRINTF_BREAK("LEXER_TOKEN_NIL");
    case LEXER_TOKEN_AND: PRINTF_BREAK("LEXER_TOKEN_AND");
    case LEXER_TOKEN_OR: PRINTF_BREAK("LEXER_TOKEN_OR");
    case LEXER_TOKEN_FUN: PRINTF_BREAK("LEXER_TOKEN_FUN");
    case LEXER_TOKEN_RETURN: PRINTF_BREAK("LEXER_TOKEN_RETURN");
    case LEXER_TOKEN_IF: PRINTF_BREAK("LEXER_TOKEN_IF");
    case LEXER_TOKEN_ELSE: PRINTF_BREAK("LEXER_TOKEN_ELSE");
    case LEXER_TOKEN_WHILE: PRINTF_BREAK("LEXER_TOKEN_WHILE");
    case LEXER_TOKEN_FOR: PRINTF_BREAK("LEXER_TOKEN_FOR");
    case LEXER_TOKEN_CLASS: PRINTF_BREAK("LEXER_TOKEN_CLASS");
    case LEXER_TOKEN_SUPER: PRINTF_BREAK("LEXER_TOKEN_SUPER");
    case LEXER_TOKEN_THIS: PRINTF_BREAK("LEXER_TOKEN_THIS");
    case LEXER_TOKEN_PRINT: PRINTF_BREAK("LEXER_TOKEN_PRINT");
