...
static void compile_string_literal(void) {
  ...
  ObjectStringLiteral *const string_literal_object = object_make_string_literal(content, content_length);

  emit_constant_instruction(value_make_object((Object *)string_literal_object));
}
