...
typedef enum {
  ...
  TERMINAL_KEY_EOF,
  TERMINAL_KEY_DELETE_CHAR_LEFT,
  TERMINAL_KEY_DELETE_CHAR_RIGHT,
  TERMINAL_KEY_DELETE_WORD_LEFT,
  TERMINAL_KEY_DELETE_WORD_RIGHT,
  TERMINAL_KEY_DELETE_LINE_LEFT,
  TERMINAL_KEY_DELETE_LINE_RIGHT,
