...
ObjectString *object_make_string(char const *content, int content_length);
ObjectStringLiteral *object_make_string_literal(char const *content, int content_length);
